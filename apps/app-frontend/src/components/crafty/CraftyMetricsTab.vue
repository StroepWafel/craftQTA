		...
		<template v-else>
			...
			>
				<div
					...
					class="flex min-h-[300px] flex-col gap-2 rounded-2xl border border-divider bg-bg-raised px-5 pb-3 pt-4"
				>
					<h3 class="m-0 text-xs font-semibold uppercase tracking-wide text-secondary">

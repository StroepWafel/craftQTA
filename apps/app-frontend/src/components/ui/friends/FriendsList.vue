...
const messages = defineMessages({
	...
	usernameTitle: {
		...
		defaultMessage: "What's your friend's craftQTA username?",
	},
	usernameDescription: {
	...
	usernamePlaceholder: {
		...
		defaultMessage: 'Enter craftQTA username...',
	},
	sendFriendRequest: {
	...
	signInToAddFriends: {
		...
		defaultMessage:
			"<link>Sign in to a craftQTA account</link> to add friends and see what they're playing!",
	},
	addFriendsToShare: {

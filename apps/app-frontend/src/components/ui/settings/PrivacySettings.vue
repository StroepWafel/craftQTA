...
<template>
	<div class="flex items-center justify-between gap-4">
		<div>
			...
			<p class="m-0 mt-1 text-sm">
				craftQTA collects anonymized analytics and usage data to improve our user experience and
	...
	<div class="mt-4 flex items-center justify-between gap-4">
		<div>
			...
			<p class="m-0 mt-1 text-sm">
				Manages the Discord Rich Presence integration. Disabling this will cause 'craftQTA' to no
